...
function createBrowserHistory(props) {
  ...
  function push(path, state) {
    process.env.NODE_ENV !== "production" ? warning(!(_typeof$1(path) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to push when the 1st ' + 'argument is a location-like object that already has state; it is ignored') : void 0;
    var action = 'PUSH';
  ...
  function replace(path, state) {
    process.env.NODE_ENV !== "production" ? warning(!(_typeof$1(path) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to replace when the 1st ' + 'argument is a location-like object that already has state; it is ignored') : void 0;
    var action = 'REPLACE';
    var location = createLocation(path, state, createKey(), history.location);
    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
      if (!ok) return;
  ...
  function parse(query, options) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        formatter(decode(_key2, options), _value, ret);
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
...
function createRouter(app, config, framework) {
  ...
  var render = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(location, action) {
      var _a, _b, _c, _d, element, pageConfig, enablePullDownRefresh, shouldLoad, delta, prev, el, _config, page;
            ...
            case 16:
              ...
              if (action === 'POP') {
                ...
                prev = stacks.find(function (s) {
                  return s.path === location.pathname + runtime.stringify(qs());
                });
              ...
              if (shouldLoad) {
                ...
                delete _config['path'];
                delete _config['load'];
                page = runtime.createPageConfig(enablePullDownRefresh ? (_d = runtime.CurrentReconciler.createPullDownComponent) === null || _d === void 0 ? void 0 : _d.call(runtime.CurrentReconciler, el, location.pathname, framework, routerConfig.PullDownRefresh) : el, location.pathname + runtime.stringify(qs()), {}, _config);
  ...
  if (exports.history.location.pathname === '/') {
    exports.history.replace(routes[0].path + exports.history.location.search);
  }
...
function findDOM(inst) {
  if (inst) {
    var find = runtime.CurrentReconciler.findDOMNode;
...
var createCanvasContext = function createCanvasContext(canvasId, inst) {
  ...
  */
  ...
  var functionProperties = [['arc'], ['arcTo'], ['beginPath'], ['bezierCurveTo'], ['clearRect'], ['clip'], ['closePath'], ['createCircularGradient', true], ['createLinearGradient', true], ['createPattern', true], ['drawImage'], ['fill'], ['fillRect'], ['fillText'], ['lineTo'], ['measureText', true], ['moveTo'], ['quadraticCurveTo'], ['rect'], ['restore'], ['rotate'], ['save'], ['scale'], ['setTransform'], ['stroke'], ['strokeRect'], ['strokeText'], ['transform'], ['translate']];
...
var Toast = /*#__PURE__*/function () {
  ...
  _createClass$1(Toast, [{
    ...
    value: function create() {
      ...
      var config = _objectSpread2$1(_objectSpread2$1({}, this.options), options); // wrapper
      ...
      if (config.image) {
        this.icon.setAttribute('style', inlineStyle(_objectSpread2$1(_objectSpread2$1({}, imageStyle), {}, {
          'background-image': "url(".concat(config.image, ")")
        })));
      } else {
        var iconStyle = config.icon === 'loading' ? loadingStyle : successStyle;
        this.icon.setAttribute('style', inlineStyle(_objectSpread2$1(_objectSpread2$1({}, iconStyle), config.icon === 'none' ? {
          display: 'none'
        } : {})));
      ...
      this.toast.setAttribute('style', inlineStyle(_objectSpread2$1(_objectSpread2$1({}, toastStyle), config.icon === 'none' ? {
        'min-height': '0',
        padding: '10px 15px'
      } : {}))); // title
    ...
    value: function show() {
      ...
      var config = _objectSpread2$1(_objectSpread2$1({}, this.options), options);
...
var Modal = /*#__PURE__*/function () {
  ...
  _createClass$1(Modal, [{
    ...
    value: function create() {
      ...
      var titleCSS = config.title ? titleStyle : _objectSpread2$1(_objectSpread2$1({}, titleStyle), {}, {
        display: 'none'
      });
      ...
      var textCSS = config.title ? textStyle : _objectSpread2$1(_objectSpread2$1({}, textStyle), {}, {
      ...
      var cancelCSS = _objectSpread2$1(_objectSpread2$1({}, btnStyle), {}, {
    ...
    value: function show() {
      ...
      if (config.title) {
        ...
        var textCSS = _objectSpread2$1(_objectSpread2$1({}, textStyle), {}, {
          padding: '40px 20px 26px',
          color: '#353535'
        });
...
var ActionSheet = /*#__PURE__*/function () {
  ...
  _createClass$1(ActionSheet, [{
    ...
    value: function create() {
      ...
      this.menu.setAttribute('style', inlineStyle(_objectSpread2$1(_objectSpread2$1({}, menuStyle), {}, {
...
var mobileDetect = createCommonjsModule$1(function (module) {
...
exports.getPreload = getPreload$1;
