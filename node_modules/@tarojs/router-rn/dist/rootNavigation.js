...
export function navigate(option, method) {
    ...
    try {
        if (method === 'navigateTo') {
            ...
            if (isTabPage()) {
                isTabPage(path)
                    ? (_j = navigationRef.current) === null || _j === void 0 ? void 0 : _j.navigate(routeParam.pageName, routeParam.params) : (_k = navigationRef.current) === null || _k === void 0 ? void 0 : _k.dispatch(StackActions.push(routeParam.pageName, routeParam.params));
            }
            else {
    ...
    if (routes) {
        routes.forEach(item => {
            ...
            if (item.name === 'tabNav') {
                ...
                const names = (_d = (_c = item.state) === null || _c === void 0 ? void 0 : _c.routeNames) !== null && _d !== void 0 ? _d : [];
