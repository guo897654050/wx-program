...
const Support = (function Support() {
  ...
  return {
    touch: (win$1.Modernizr && win$1.Modernizr.touch === true) || (function checkTouch() {
      return !!(('ontouchstart' in win$1) || (win$1.DocumentTouch && doc$1 instanceof win$1.DocumentTouch));
    }()),

    pointerEvents: !!(win$1.navigator.pointerEnabled || win$1.PointerEvent || ('maxTouchPoints' in win$1.navigator)),
...
function onTouchStart (event) {
  ...
  if (e.type !== 'touchstart') {
    ...
    if (
      doc$1.activeElement
      && $(doc$1.activeElement).is(data$$1.formElements)
...
function onTouchMove (event) {
  ...
  if (data$$1.isTouchEvent && doc$1.activeElement) {
    if (e.target === doc$1.activeElement && $(e.target).is(data$$1.formElements)) {
      data$$1.isMoved = true;
      swiper.allowClick = false;
      return;
    }
