...
class CameraContext {
    constructor(cameraRef) {
        ...
        this.takePhoto = (option) => {
            ...
            Permissions.askAsync(Permissions.CAMERA, Permissions.AUDIO_RECORDING).then(() => { var _a; return (_a = this.cameraRef) === null || _a === void 0 ? void 0 : _a.takePictureAsync({ quality: quality }).then(res => {
                var _a;
                const { uri } = res;
            ...
            }).finally(() => { var _a; return (_a = option === null || option === void 0 ? void 0 : option.complete) === null || _a === void 0 ? void 0 : _a.call(option, { errMsg: '' }); }); }).catch((e) => console.log(e));
        };
        /**
         * 获取 Camera 实时帧数据
         * not support
